...
document.title = 'Alanna Mathieu | Lambda';
  ...
  return (
    ...
    <div>
      ...
      <div style={{padding: '50px 250px 0 250px', textAlign: 'left'}}>
        <h2 style={{color: lightblue, fontWeight: '900', fontSize: '2.5rem', padding: '30px 0 50px 0'}}>Studying at Lambda</h2>
        
        <p>
        I currently work as a Jr. Web Developer (Online Specialist) at <a className="btn-link" href='https://lambdaschool.com/' target='_blank' rel="noopener noreferrer">Lambda School</a>, a travel/leisure 
      ...
      <div style={{textAlign: 'left', paddingLeft: '250px'}}>
                ...
                <div style={{padding: '0 250px 80px 0', display: 'flex'}}>
                  <div>
                    ...
                    <p>My third goal was birthed during the covid-19 pandemic in early 2020. While working from home was
                      ...
                      environment and ensure I was being just as effective and productive as I was in the office.
                    </p>
                  </div>
            ...
            <div style={{textAlign: 'right', paddingRight: '250px'}}>
                <h3 style={{fontSize: '2rem', padding: '0 0 50px 0'}}>Challenges + Growth</h3>
                <img style={{maxWidth: '900px', padding: '0 0 50px 0'}} src={imageFour} alt='image-ayye'/>
                <div style={{padding: '0 0 80px 250px'}}>
                  <p>
                    ...
                    help of some talented seniors, I was able to survive the learning curve.</p>
                  <p>
