...
function Project(props) {
  ...
  return (
    <div>
        <div style={{width: '600px', height: '200px', padding: '20px 0', marginTop: '60px', backgroundColor: 'white', display: 'grid', placeItems: 'center'}}>

            <h1 style={{color: '#2B2C2B', fontSize: '2rem', fontWeight: '900'}}>{props.title}</h1>
            <p style={{padding: '0 50px', fontSize: '1rem', lineHeight: '1.5rem'}}>{props.description}</p>
